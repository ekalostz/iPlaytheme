...
export const newsIcon = () => (
  <Icon style={{ paddingTop:6, fontSize:20, color:"#FF9D1A" }} name="newspaper-o" pack="fontawesome" />
);

export const exploreIcon = () => (
  <Icon style={{ paddingTop:4, fontSize:22, color:"gray" }} name="explore" pack="material" />
);
